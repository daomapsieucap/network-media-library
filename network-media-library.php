 ...
 * @author    John Blackbourn <john@johnblackbourn.com>, Dominik Schilling <d.schilling@inpsyde.com>, Frank Bültge
 *            <f.bueltge@inpsyde.com>
 * @copyright 2019 Human Made
 * @license   https://opensource.org/licenses/MIT
 *
 * Plugin Name: Network Media Library
 * Description: Network Media Library provides a central media library that's shared across all sites on the Multisite
 * network. Network:     true Plugin URI:  https://github.com/humanmade/network-media-library Version:     1.5.0
 * Author:      John Blackbourn, Dominik Schilling, Frank Bültge Author URI:
 * https://github.com/humanmade/network-media-library/graphs/contributors License:     MIT License URI: ./LICENSE Text
 * Domain: network-media-library Domain Path: /languages Requires PHP: 7.0
 */
...
/**
 * Returns whether or not we're currently on the network media library site, regardless of any switching that's
 * occurred.
 *
...
/**
 * Filter the image HTML so its HTML points to the network media library site.
 */
...
/**
 * Filter attached file path based on attachment ID to the network media library site.
 */
